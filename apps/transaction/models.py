...
class DataLabelMeta(models.Model):
    variable_name = models.CharField(max_length=512, unique=True)
    verbose_name = models.CharField(max_length=512, blank=True,
                                                    default="")
    label = models.CharField(max_length=512, blank=True,
                                                    default="")
    question_text = models.CharField(max_length=512, blank=True,
                                                    default="")
    
    def __unicode__(self):
        return "%s|%s|%s|%s" % (self.variable_name,
                                self.verbose_name,
                                self.label,
                                self.question_text)
