...
import csv
import xlwt
from utils import (get_collection_keys, build_non_observational_key,
...
def tupleize(rows):
    """Also alphabetizes columns and retuns a tulpe of tuples"""
...
def excelify(rows, sheet_name="Sheet1"):
    wb      = xlwt.Workbook()
